...
function processEvent(event, callback) {
    ...
    const emojitext = commandText.match(/:([^:]+):/)[1];
    console.log(commandText);

getEmojiURL(emojitext).then(function (value) {
    const emojiurl = value; 
    callback(null, {
...
return new Promise(function (resolve, reject) {
  ...
  const url = 'https://slack.com/api/emoji.list?token='+url_token+'&pretty=1';
